...
def train(args):
    ...
    for epoch in range(args.epoch):
        ...
        for data_ in tq(trainloader):
            ...
            with torch.no_grad():
                rec_images = SNet(Variable(all_seq))
            ...
            rec_images = SNet(Variable(input_))
    ...
    # store model weights
    transportables = {'SNet': SNet.state_dict(), 'client_info': ['t1', 't1ce', 't2']}
    ...
    del trainReconLoss, transportables, SNet, input_, all_seq, _t1, _t1ce, _t2
